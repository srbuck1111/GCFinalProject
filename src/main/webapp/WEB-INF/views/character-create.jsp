...
body {
	background-image:
		url("https://wallpaperplay.com/walls/full/8/c/6/102152.jpg");
   ...
   <source src="http://www.ffmages.com/ffvii/ost/disc-3/19-aeriths-theme.mp3" type="audio/mpeg">
		...
		<div>
			<div class="row">
				<div class="column">
					...
					<br>
					<center>
						<input class="btn btn-secondary" placeholder="First Name"
							type="text" name="firstName" required />
					</center>
					<br />
					<br />
					<center>
						<input class="btn btn-secondary" placeholder="Last Name"
							type="text" name="lastName" required />
					</center>
					<br />
					<br />
					<center>
						<h4>Need help? Hover over fields for additional details!</h4>
					</center>
					<br>
					<br>
					<center>
						<span title="Click to choose your character class!"><select
							class="btn btn-secondary" name="classId">
				...
				<div class="column">
					...
					<center>
						<h6>Strength</h6>
						<span
							title="Strength increases your damage potential. You must invest at least 8 points in this stat, but 16 is the max!"><input
							min="8" max="16" class="btn btn-outline-secondary" value="10"
							id="str" type="number" name="str" oninput="checkPointBuy()" /></Span><br />
						<h6>Constitution</h6>
						<span
							title="Constitution increases your health and endurance. You must invest at least 8 points in this stat, but 16 is the max!"><input
							min="8" max="16" class="btn btn-outline-secondary" value="10"
						...
						<h6>Intelligence</h6>
						<span
							title="Intelligence controls your skill with magic, and stat points per level. You must invest at least 8 points in this stat, but 16 is the max!"><input
							min="8" max="16" class="btn btn-outline-secondary" value="10"
						...
						<span title="This is how many points you have remaining to invest"><input
							class="btn btn-secondary" type="text" id="pointsRemaining" /></span> <span
							title="Click here to create your character"><input
							class="btn btn-success" type="submit" value="Create" /></span>
	...
	<script>
		...
		function checkPointBuy() {
			...
			pointsRemaining.value = 75 - str.value - con.value - dex.value
					- intel.value - wis.value - cha.value;
			if (pointsRemaining.value < 0) {
				pointsRemaining.value = "not enough points!";
				pointsRemaining.style = "color:red";
			}
			if (str.value > 20 || con.value > 20 || dex.value > 20
					|| intel.value > 20 || wis.value > 20 || cha.value > 20) {
				alertHigh.innerHTML = "stats cannot be higher than 20!";
			}
			if (str.value <= 0 || con.value <= 0 || dex.value <= 0
					|| intel.value <= 0 || wis.value <= 0 || cha.value <= 0) {
